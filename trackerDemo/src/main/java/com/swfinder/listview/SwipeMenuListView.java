...
public class SwipeMenuListView extends ListView {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                //Assign value only when empty to avoid assigning values ​​for each touch, else
                //will be multiple open states
                if (view instanceof SwipeMenuLayout) {
                    //If it is open, intercept it
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                break;
            case MotionEvent.ACTION_MOVE:
                //Some might have header, therefore remove the header
    ...
    /**
     * Determine if the click event is within a view
     *
     * @param view
     * @param ev
     * @return
